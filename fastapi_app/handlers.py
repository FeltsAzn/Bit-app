...
from fastapi import APIRouter, Body, Path, HTTPException, status, Header
...
@router.get('/get_info_by_user/{user_id}')
...
@router.get('/get_user_by_tg/{tg_id}')
...
@router.get("/get_user_balance/{tg_id}")
...
@router.get("/get_user_transactions/{tg_id}")
